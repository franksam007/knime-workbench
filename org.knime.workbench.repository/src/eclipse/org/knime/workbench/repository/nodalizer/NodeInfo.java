...
public class NodeInfo {
     ...
     *
     * @return a 16 character unique id
     */
    public String getId() {
        // TODO the ID is currently derived from the factory class name. As soon as that changes, also the ID
        // changed. We still need to find a way to define a truly unique id for nodes.

        try {
            byte[] digest = MessageDigest.getInstance("SHA-256").digest(getFactoryName().getBytes(StandardCharsets.UTF_8));
