 ...
 */
public class TextAreaMetaInfoAtom extends MetaInfoAtom {
    private Text m_editTextArea;
    ...
    public void commitEdit() {
        m_value = m_editTextArea.getText();
        m_editTextArea = null;
    }
    ...
    public void populateContainerForDisplay(final Composite parent) {
        ...
        l.setFont(WorkflowMetaView.NOT_AUTHOR_FONT);
    ...
    public void populateContainerForEdit(final Composite parent) {
        ...
        m_editTextArea = new Text(parent, SWT.MULTI | SWT.V_SCROLL | SWT.WRAP | SWT.BORDER);
        ...
        m_editTextArea.setLayoutData(gd);
        m_editTextArea.setText((m_value == null) ? "" : m_value);
    }
